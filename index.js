...
log(addFlavor("Rainbow Sherbert", originalFlavors));
...
log(getFlavorByIndex(originalFlavors, 2));


/*🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 6: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
As corporate wants to add more and more flavors to their lineup, they've realized that they need to remove flavors based on flavor name, 
as opposed to just arbitrarily removing the first or last flavor. Your task is to get an index by flavor name, and remove that single flavor
from the array.  
...
Use the removeFlavorByName function below to do the following:
    ...
    For example: running removeFlavorByName(originalFlavors, "Rocky Road") would return an array with the a length of 30 because Rocky Road
...
log(removeFlavorByName(originalFlavors, "Rocky Road"));
